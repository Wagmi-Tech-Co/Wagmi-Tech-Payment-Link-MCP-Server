...
class PaymentMCPServer:
    ...
    def _register_tools(self):
        ...
        async def create_payment_link(
            ...
            - installment_number: Number of installments. (0, 1, or null means single payment). Default is 0.
            ...
            - is_commission_diff_by_dealer: If dealer pays for N installments, this decides commission for >N. 0: Customer pays full commission. 1: Customer pays the difference. (default is )
